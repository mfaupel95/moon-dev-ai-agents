...
# Keltner Channel
kc_atr = keltner_breakout_strategy.I(talib.ATR, keltner_breakout_strategy.data.High, timeperiod=20, multiplier=2)
...
# Bollinger Bands
bb_atr = keltner_breakout_strategy.I(talib.ATR, keltner_breakout_strategy.data.High, timeperiod=20, multiplier=2)
